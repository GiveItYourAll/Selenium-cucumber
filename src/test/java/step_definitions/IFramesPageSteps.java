...
public class IFramesPageSteps {
    ...
    public void user_clicks_on_video_play_button() {
        ...
        WaitsUtils.waitForElementToBeClickable(iFramesPage.playButton, 10);
    ...
    public void user_can_see(String expectedMessage) {
        if (expectedMessage.contains("content")) {
            ...
            String contentMessage = iFramesPage.content.getText();
    ...
    public void user_enters_an_email() {
        iFramesPage.field.sendKeys(Keys.PAGE_DOWN);

        Driver.getDriver().switchTo().defaultContent();
        Driver.getDriver().switchTo().frame("email-subscribe");
        WaitsUtils.waitForVisibilityOfElement(iFramesPage.field2, 10);
        iFramesPage.field2.sendKeys(iFramesPage.getRandomEmail());
        iFramesPage.field2.sendKeys(Keys.PAGE_DOWN);
